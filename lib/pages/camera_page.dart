      ...
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          if (constraints.maxWidth <= 600) {
            return SetLayoutPage(widthEditText: 32);
          } else if (constraints.maxWidth <= 800) {
            return SetLayoutPage(widthEditText: 150);
          } else if (constraints.maxWidth <= 1000) {
            return SetLayoutPage(widthEditText: 250);
          } else if (constraints.maxWidth <= 1200) {
            return SetLayoutPage(widthEditText: 300);
          } else if (constraints.maxWidth <= 1400) {
            return SetLayoutPage(widthEditText: 400);
          } else {
            return SetLayoutPage(widthEditText: 500);
          }
        },
      ),
    );
...
class SetLayoutPage extends StatelessWidget {
  final double widthEditText;

  const SetLayoutPage({this.widthEditText});
      ...
      child: Container(
        child: Column(
          children: <Widget>[
            ...
            Padding(
              padding:
                  EdgeInsets.symmetric(horizontal: widthEditText, vertical: 8),
              child: TextField(
                style: TextStyle(color: Colors.white),
                textInputAction: TextInputAction.next,
                decoration: InputDecoration(
            ...
            Padding(
              padding:
                  EdgeInsets.symmetric(horizontal: widthEditText, vertical: 24),
